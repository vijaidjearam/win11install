...
Function EnableNumlockloginscreen {
	...
	Set-ItemProperty -Path "HKU:\.DEFAULT\Control Panel\Keyboard" -Name "InitialKeyboardIndicators" -Value 8000002 -force
	Add-Type -AssemblyName System.Windows.Forms
	If (!([System.Windows.Forms.Control]::IsKeyLocked('NumLock'))) {
		$wsh = New-Object -ComObject WScript.Shell
		$wsh.SendKeys('{NUMLOCK}')
...
#$temp = Get-AppxPackage -AllUsers | where-object {$_.packagename -notlike "*Microsoft.WindowsStore*"} | where-object {$_.packagename -notlike "*Microsoft.WindowsCalculator*"} | where-object {$_.packagename -notlike "*Microsoft.Windows.Photos*"} | where-object {$_.packagename -notlike "*Microsoft.MSPaint*"} | where-object {$_.packagename -notlike "*Microsoft.NET.Native.Runtime*"}
 ...
 #catch{
  ...
  # }
#}
Get-AppxPackage -AllUsers | where-object {$_.name -notlike "*Microsoft.WindowsStore*"} | where-object {$_.name -notlike "*Microsoft.WindowsCalculator*"} | where-object {$_.name -notlike "*Microsoft.Windows.Photos*"} | where-object {$_.name -notlike "*Microsoft.Paint*"} | where-object {$_.name -notlike "*Microsoft.NET.Native.Runtime*"} | where-object {$_.name -notlike "*Microsoft.NET.Native.Framework*"} | where-object {$_.name -notlike "*Microsoft.VCLibs*"} | where-object {$_.name -notlike "*Microsoft.Services.Store*"} | where-object {$_.name -notlike "*Microsoft.UI.Xaml*"} | where-object {$_.name -notlike "*Microsoft.UI.Xaml*"} | where-object {$_.name -notlike "*Microsoft.MicrosoftEdge*"} | where-object {$_.name -notlike "*Microsoft.Win32WebViewHost*"} | where-object {$_.name -notlike "*Microsoft.Windows.ShellExperienceHost*"} | where-object {$_.name -notlike "*Windows.PrintDialog*"} | where-object {$_.name -notlike "*Microsoft.WebpImageExtension*"} | where-object {$_.name -notlike "*Microsoft.VP9VideoExtensions*"} | where-object {$_.name -notlike "*Microsoft.UI.Xaml*"} | where-object {$_.name -notlike "*Microsoft.DesktopAppInstaller*"} | where-object {$_.name -notlike "*Microsoft.Windows.CallingShellApp*"} | where-object {$_.name -notlike "*Microsoft.WindowsSoundRecorder*"} | where-object {$_.name -notlike "*Microsoft.StorePurchaseApp*"} | where-object {$_.name -notlike "*AppUp.IntelGraphicsControlPanel*"} | where-object {$_.name -notlike "*Microsoft.Windows.ShellExperienceHost*"} | where-object {$_.name -notlike "*Microsoft.Windows.StartMenuExperienceHost*"} | Remove-AppxPackage
}
